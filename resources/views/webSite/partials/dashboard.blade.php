...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div
            class="p-8 flex flex-col gap-6 rounded-3xl border border-white/10 bg-gradient-to-b from-[#1A1953] to-[#080616] shadow-2xl transition-transform hover:scale-[1.02]">
            ...
            <a href="/dashboard/history" class="group mt-4">
                <button
                    class="w-full py-4 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-2xl transition-all shadow-lg shadow-indigo-500/20 active:scale-95 hover:cursor-pointer">
                    Check History
                </button>
            </a>
        </div>
        ...
        <div class="p-8 rounded-3xl border border-white/5 bg-white/5 backdrop-blur-sm flex flex-col justify-between">
            ...
            <div class="grid grid-cols-2 gap-4 mt-6">
                <a href="/addIncomes">
                    <button
                        class="p-4 bg-white/5 rounded-2xl hover:bg-white/10 transition-all text-sm border border-white/5">
                        Add Income
                    </button>
                </a>
                <a href="/addExpenses">
    ...
    <div class="mt-10 p-8 rounded-3xl border border-white/10 bg-white/5 backdrop-blur-sm shadow-2xl">
        <div class="flex justify-between items-center mb-6">
            ...
            <select
                class="bg-[#080616] text-white border border-white/10 rounded-lg px-4 py-2 text-sm outline-none focus:border-indigo-500">
