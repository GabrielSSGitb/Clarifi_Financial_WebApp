...
<header class="mb-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
    <div>
        <h1 class="text-4xl font-bold tracking-tight text-white">
            {{ $greeting }}, <span class="text-indigo-400">{{ $currentUser->name }}</span>
        </h1>
        <p class="text-gray-500 mt-2">
            Viewing <span class="text-gray-300 font-medium">{{ $monthNames[$filterMonth] }} {{ $filterYear }}</span>
        </p>
    </div>

    <form method="GET" action="/dashboard"
          class="flex flex-wrap items-center gap-3 bg-white/5 border border-white/10 rounded-2xl p-3">
        <div class="flex flex-col gap-1">
            <label class="text-[10px] uppercase tracking-widest text-gray-500 ml-1">Month</label>
            <select name="month"
                    class="bg-[#080616] text-white border border-white/10 rounded-xl px-4 py-2 text-sm outline-none focus:border-indigo-500 transition-colors min-w-[130px]">
        ...
        <div class="flex flex-col gap-1">
            <label class="text-[10px] uppercase tracking-widest text-gray-500 ml-1">Year</label>
            <select name="year"
                    class="bg-[#080616] text-white border border-white/10 rounded-xl px-4 py-2 text-sm outline-none focus:border-indigo-500 transition-colors">
        ...
        <div class="flex flex-col gap-1">
            <label class="text-[10px] uppercase tracking-widest text-transparent ml-1 select-none">Apply</label>
            <button type="submit"
                    class="px-5 py-2 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold rounded-xl text-sm transition-all active:scale-95 shadow-lg shadow-indigo-500/20">
                Apply
            </button>
        </div>
    </form>
