...
<header>
    <nav class="flex flex-col gap-5 p-4 h-screen w-15 bg-gray-800">
        ...
        <a href="#" class="hover:text-[#408A71] hover:size-6 hover:animate-pulse">
        ...
        <a href="#" class="hover:text-[#408A71] hover:size-6 hover:animate-pulse hover:-translate-y-1 hover:scale-110">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                     stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
