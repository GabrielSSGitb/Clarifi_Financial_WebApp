...
<aside class="group w-20 hover:w-56 h-screen sticky top-0 bg-[#1A1953]/20 backdrop-blur-xl border-r border-white/5 flex flex-col items-start py-8 gap-6 transition-all duration-300 overflow-hidden z-50">
    ...
    <nav class="flex flex-col gap-2 w-full px-3">
        <a href="/" class="flex items-center gap-3 p-3 bg-indigo-600 rounded-2xl text-white shadow-lg shadow-indigo-500/40 transition-all">
        ...
        <a href="/addIncomes" class="flex items-center gap-3 p-3 text-gray-500 hover:text-emerald-400 hover:bg-white/5 rounded-2xl transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 flex-shrink-0">
        ...
        <a href="/expense" class="flex items-center gap-3 p-3 text-gray-500 hover:text-red-400 hover:bg-white/5 rounded-2xl transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 flex-shrink-0">
        ...
        <a href="/history" class="flex items-center gap-3 p-3 text-gray-500 hover:text-indigo-400 hover:bg-white/5 rounded-2xl transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 flex-shrink-0">
        ...
        <a href="/calendar" class="flex items-center gap-3 p-3 text-gray-500 hover:text-emerald-400 hover:bg-white/5 rounded-2xl transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 flex-shrink-0">
        ...
        <a href="/investments" class="flex items-center gap-3 p-3 text-gray-500 hover:text-emerald-400 hover:bg-white/5 rounded-2xl transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 flex-shrink-0">
    ...
    <a href="/profile" class="mt-auto w-full px-3 flex items-center gap-3 p-3 text-gray-500 hover:text-white hover:bg-white/5 rounded-2xl transition-all">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 flex-shrink-0">
